              ...
              <div class="card">
                ...
                <div class="card-header card-header-primary">
                  ...
                  <div class="pull-right">
                   <a style="background: white; color: black" href="conn/Ingredients/addIngre.php" class="btn btn-primary"><i class="material-icons">add</i>Nuevo</a>               
                   </div>
                  <div class="pull-right">
                   <a style=" margin-right: 15PX; margin-top: -3px" target="_blank" href="reportes/reportIngredientes.php" class="btn btn-primary"><img src="assets/img/pdf.png" alt="" ></a>               
                   </div>
                  <p class="card-category"> Ingredientes utilizados</p>
    ...
    <script src="assets/js/jquery.min.js"></script>
        ...
        var dataTable = $('#lookup').DataTable( {
         ...
         "language":  {
          ...
          "serverSide": true,
          "ajax":{
            url :"conn/Ingredients/data-Ingre.php", // json datasource
