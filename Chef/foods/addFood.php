      ...
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            <a class="navbar-brand">Agregar alimento</a>
          </div>
	...
	<!-- End Navbar -->
      <div class="content">
            ...
            <div class="col-md-12">
              <div class="card">
                ...
                <div class="card-header card-header-primary">
                  ...
                  <p class="card-category"> Agregar alimentos</p>
		...
		<form method="post" action="addingrediente.php" class="form-horizontal row-fluid" style="padding: 10px; background-color: white; border-radius: 10px">
			...
			<?php
          $queryy = $conn -> query ("SELECT * FROM ingredientes WHERE exis = 1");
		...
		<?php
          $query = $conn -> query ("SELECT * FROM tipo_alimento WHERE estado = 1");
          while ($valores = mysqli_fetch_array($query)) {
            echo '<option value="'.$valores[idTipoAlimento].'">'.$valores[nombreTipo].'</option>';
          }
        ?>
			</select><br>
			<label for="nombreAlimento">Nombre del alimento:</label>
			<input autocomplete="off" autofocus class="form-control" name="nombreAlimento" required type="text" id="nombreAlimento" placeholder="Escribe el nombre" type="text" minlength="3"><br>
