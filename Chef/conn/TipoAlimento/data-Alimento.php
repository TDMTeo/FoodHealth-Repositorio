...
$sql = "SELECT idTipoAlimento, nombreTipo, estado";
$sql.=" FROM tipo_alimento ";
$query=mysqli_query($conn, $sql) or die("data-Alimento.php: get InventoryItems");
...
if( !empty($requestData['search']['value']) ) {
	$sql = "SELECT idTipoAlimento, nombreTipo, estado";
    $sql.=" FROM tipo_alimento ";
	$sql.=" WHERE  nombreTipo LIKE '".$requestData['search']['value']."%' ";  
	$query=mysqli_query($conn, $sql) or die("data-Alimento.php: get PO");
