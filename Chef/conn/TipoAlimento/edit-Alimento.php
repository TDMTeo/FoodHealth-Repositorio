      ...
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse justify-content-end">
           ...
           $id = intval($_GET['idTipoAlimento']);
            $sql = mysqli_query($conn, "SELECT * FROM tipo_alimento WHERE idTipoAlimento='$id'");
            if(mysqli_num_rows($sql) == 0){
                header("Location: ../../../../tipoAlimento.php");
            }else{
              ...
              <div class="card">
                ...
                <div class="card-body">
                  <div class="table-responsive">
                    <div class="container" >
                      <form name="form1" id="form1" class="form-horizontal row-fluid" action="update-Alimento.php" method="POST" style="padding: 10px; background-color: white; border-radius: 10px">
                            <div  style="width: 100%">
                                  <div class="control-group">
                                           
                                            <div class="controls">
                                                <input  type="hidden" name="idTipoAlimento" id="idTipoAlimento" value="<?php echo $row['idTipoAlimento']; ?>" placeholder="Tidak perlu di isi" class="form-control span8 tip" readonly="readonly">
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="controls">
                                                <input type="text" name="nombreTipo" id="nombreTipo" placeholder="Nombre Tipo Alimento" value="<?php echo $row['nombreTipo']; ?>" minlength="3" class="form-control span8 tip" required>
                                            </div> 
                                            </div>
                                        </div>
                                        <?php
                                        ...
                                        <div class="control-group">
                                            <div class="controls">
                                               ...
                                               <a href="../../tipoAlimento.php" class="btn btn-danger pull-right"><i class="material-icons">clear</i> Cancelar</a>
                                            </div>
                                        </div>
                            </div>
