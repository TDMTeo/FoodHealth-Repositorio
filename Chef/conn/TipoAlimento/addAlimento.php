        ...
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse justify-content-end">
            ...
            if(isset($_POST['input'])){
                ...
                $insert = mysqli_query($conn, "INSERT INTO tipo_alimento(idTipoAlimento, nombreTipo, estado)
                        ...
                        if($insert){
                            echo "<script>
                              Swal.fire({
                                ...
                                html: '<h5> Tipo Alimento agregado correctamente </h5>',
                                type: 'success',
                                padding: '3em',
                                timer: 2000,
                          ...
                          Swal.fire({
                            ...
                            html: '<h5> Error al agregar el Tipo Alimento </h5>',
                            width: 400,
                            type: 'success',
                            padding: '3em',
                            timer: 2000,
            ...
            <div class="col-md-12">
              <div class="card">
                ...
                <div class="card-header card-header-primary">
                  ...
                  <p class="card-category"> Agregar Tipo Alimento</p>
                  
                </div>
                <div class="card-body">
                  <div class="table-responsive">
                    <div class="container" >
                    <form name="form1" id="form1" class="form-horizontal row-fluid" action="addAlimento.php" method="POST" style="padding: 10px; background-color: white; border-radius: 10px">
                            <div style="width: 100%" >
                                <div class="row">
                                            <div class="col">
                                               <label class="control-label" for="nombreTipoo"></label>
                                            <div class="controls">
                                                <input type="text" name="nombreTipo" id="nombreTipo" placeholder="Nombre " minlength="3" maxlength="20" class="form-control span8 tip" required>
                                            </div> 
                                            </div>
                                        </div>
                                    ...
                                    <br>   
                                        <div class="control-group">
                                            <div class="controls">
                                                <button type="submit" name="input" id="input" class="btn btn-primary"><i class="material-icons">savex</i> Agregar</button>
