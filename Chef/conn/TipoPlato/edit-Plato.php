      ...
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse justify-content-end">
           ...
           $id = intval($_GET['idTipoPlato']);
            $sql = mysqli_query($conn, "SELECT * FROM tipo_Plato WHERE idTipoPlato='$id'");
            if(mysqli_num_rows($sql) == 0){
                header("Location: ../../../../tipoPlato.php");
            }else{
            ...
            <div class="col-md-12">
              <div class="card">
                ...
                <div class="card-header card-header-primary">
                  ...
                  <p class="card-category"> Editar Plato</p>
                  
                </div>
                <div class="card-body">
                  <div class="table-responsive">
                    <div class="container" >
                      <form name="form1" id="form1" class="form-horizontal row-fluid" action="update-Plato.php" method="POST" style="padding: 10px; background-color: white; border-radius: 10px">
                            <div  style="width: 100%">
                                  <div class="control-group">
                                           
                                            <div class="controls">
                                                <input  type="hidden" name="idTipoPlato" id="idTipoPlato" value="<?php echo $row['idTipoPlato']; ?>" placeholder="Tidak perlu di isi" class="form-control span8 tip" readonly="readonly">
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="controls">
                                                <input type="text" name="nombrePlato" id="nombrePlato" placeholder="Nombre Tipo Plato" value="<?php echo $row['nombrePlato']; ?>" minlength="3" class="form-control span8 tip" required>
                                            </div> 
                                            </div>
                                        </div>
                                        <?php
                                                ...
                                                <label class="control-label">Estado</label>
                                                  <div class="input-group" >
                                                   <select name="estado" id="estado" class=" form-control " >
                                                    <option value="<?php echo $estado1; ?>"><?php if ($estado1 == 0) {
                                                        echo "No hay";
                                                    }else {
                                                        echo "Si hay";
                                                    } ?></option>
                                                    <option value="<?php echo $estado2; ?>"><?php if ($estado2 == 0) {
                                                        echo "No Hay";
                                                    }else {
                                                        echo "Si hay";
                                                    } ?></option>
