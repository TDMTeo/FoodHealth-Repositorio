      ...
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            <a class="navbar-brand" href="javascript:;">Tipo Plato</a>
          </div>
          ...
          <div class="collapse navbar-collapse justify-content-end">
            ...
            if(isset($_POST['input'])){
                $nombre = mysqli_real_escape_string($conn,(strip_tags($_POST['nombrePlato'], ENT_QUOTES)));
                $insert = mysqli_query($conn, "INSERT INTO tipo_plato (idTipoPlato, nombrePlato,estado)
                    VALUES(NULL,'$nombre',1)") or die(mysqli_error());
                        ...
                        if($insert){
                            echo "<script>
                              Swal.fire({
                                ...
                                html: '<h5> Tipo Plato agregado correctamente </h5>',
                                type: 'success',
                                padding: '3em',
                                timer: 2000,
                          ...
                          Swal.fire({
                            ...
                            html: '<h5> Error al agregar el Tipo Plato </h5>',
                            width: 400,
                            type: 'success',
                            padding: '3em',
                            timer: 2000,
            ...
            <div class="col-md-12">
              <div class="card">
                ...
                <div class="card-header card-header-primary">
                  <h4 class="card-title "> Tipo Plato</h4>
                  <p class="card-category"> Agregar Tipo Plato</p>
                  
                </div>
                <div class="card-body">
                  <div class="table-responsive">
                    <div class="container" >
                    <form name="form1" id="form1" class="form-horizontal row-fluid" action="addPlato.php" method="POST" style="padding: 10px; background-color: white; border-radius: 10px">
                            <div style="width: 100%" >
                                <div class="row">
                                            <div class="col">
                                               <label class="control-label" for="nombreTipoo"></label>
                                            <div class="controls">
                                                <input type="text" name="nombrePlato" id="nombrePlato" placeholder="Nombre Tipo Plato" minlength="3" maxlength="20" class="form-control span8 tip" required>
                                            </div> 
                                            </div>
                                        </div>
                                    ...
                                    <br>   
                                        <div class="control-group">
                                            <div class="controls">
                                               ...
                                               <a href="../../tipoPlato.php" class="btn  btn-danger pull-right"><i class="material-icons">clear</i> Cancelar</a>
                                            </div>
                                        </div> <br><br><br>            
                            </div>  
                    </form>
