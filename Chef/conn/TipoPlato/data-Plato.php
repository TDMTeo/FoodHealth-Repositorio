...
$sql = "SELECT idTipoPlato, nombrePlato, estado";
$sql.=" FROM tipo_plato ";
$query=mysqli_query($conn, $sql) or die("data-Plato.php: get InventoryItems");
...
if( !empty($requestData['search']['value']) ) {
	$sql = "SELECT idTipoPlato, nombrePlato, estado";
    $sql.=" FROM tipo_plato ";
	$sql.=" WHERE  nombrePlato LIKE '".$requestData['search']['value']."%' ";  
	$query=mysqli_query($conn, $sql) or die("data-Plato.php: get PO");
