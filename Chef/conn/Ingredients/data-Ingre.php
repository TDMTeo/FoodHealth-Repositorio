...
$query=mysqli_query($conn, $sql) or die("data-Ingre.php: get InventoryItems");
...
if( !empty($requestData['search']['value']) ) {
	...
	$query=mysqli_query($conn, $sql) or die("data-Ingre.php: get PO");
