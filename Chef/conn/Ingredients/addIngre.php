        ...
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse justify-content-end">
            ...
            if(isset($_POST['input'])){
                ...
                $insert = mysqli_query($conn, "INSERT INTO ingredientes(id, nombre, cantidad, colesterol, calorias, grasa, azucar, carbohidratos,exis)
                    VALUES(NULL,'$nombre', '$cantidad', '$colesterol', '$calorias', '$grasa', '$azucar', 
                    '$carbohidratos,exis', 1)") or die(mysqli_error());
                        ...
                        if($insert){
                            echo "<script>
                              Swal.fire({
                                ...
                                html: '<h5> Ingrediente agregado correctamente </h5>',
                                type: 'success',
                                padding: '3em',
                                timer: 2000,
                          ...
                          Swal.fire({
                            ...
                            html: '<h5> Error al agregar el Ingrediente </h5>',
                            width: 400,
                            type: 'success',
                            padding: '3em',
                            timer: 2000,
              ...
              <div class="card">
                ...
                <div class="card-body">
                  <div class="table-responsive">
                    <div class="container" >
                    <form name="form1" id="form1" class="form-horizontal row-fluid" action="addIngre.php" method="POST" style="padding: 10px; background-color: white; border-radius: 10px">
                            <div style="width: 100%" >
                                <div class="row">
                                            <div class="col">
                                               <label class="control-label" for="nombre"></label>
                                            <div class="controls">
                                                <input type="text" name="nombre" id="nombre" placeholder="Nombre" minlength="3" maxlength="20" class="form-control span8 tip" required>
                                            </div> 
                                            </div>
                                            <div class="col">
                                               <label class="control-label" for="cantidad"></label>
                                            <div class="controls">
                                                <input type="number" name="cantidad" id="cantidad" placeholder="Cantidad(Gr)" maxlength="5" class="form-control span8 tip" required>
                                            </div> 
                                            </div>
                                            <div class="col">
                                                <label class="control-label" for="colesterol"></label>
                                            <div class="controls">
                                                <input type="number" minlength="1" name="colesterol" id="colesterol" maxlength="4" placeholder="Colesterol(Mg)" class="form-control span8 tip" required>
                                            </div>
                                            </div>
                                        </div>
                                         ...
                                         <div class="row">
                                            <div class="col">
                                               <label class="control-label" for="calorias"></label>
                                            <div class="controls">
                                                <input type="number" minlength="1" name="calorias" id="calorias" placeholder="Calorias(Gr)" maxlength="4" class="form-control span8 tip" required>
                                            </div> 
                                            </div>
                                            <div class="col">
                                                <label class="control-label" for="grasa"></label>
                                            <div class="controls">
                                                <input type="number" minlength="1" name="grasa" id="grasa" maxlength="4" placeholder="Grasa(Gr)" class="form-control span8 tip" required>
                                            </div>
                                            </div>
                                        </div>
                                         <div class="row">
                                            <div class="col">
                                               <label class="control-label" for="azucar"></label>
                                            <div class="controls">
                                                <input type="number" name="azucar" minlength="1" id="azucar" placeholder="Azucar(Gr)" maxlength="4" class="form-control span8 tip" required>
                                            </div> 
                                            </div>
                                            <div class="col">
                                                <label class="control-label" for="carbohidratos"></label>
                                            <div class="controls">
                                                <input type="number" name="carbohidratos" minlength="1" id="Carbohidratos" maxlength="4" placeholder="Carbohidratos(Gr)" class="form-control span8 tip" required>
                                            </div>
                                            </div>
                                        </div>
                                    <br>   
                                        <div class="control-group">
                                            <div class="controls">
                                                <button type="submit" name="input" id="input" class="btn btn-primary"><i class="material-icons">save</i> Agregar</button>
