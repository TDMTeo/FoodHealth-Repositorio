              ...
              <div class="card">
                ...
                <div class="card-header card-header-primary">
                  ...
                  <div class="pull-right">
                   <a style="background: white; color: black" href="conn/TipoPlato/addPlato.php" class="btn btn-primary"><i class="material-icons">add</i>Nuevo</a>               
                   </div>
                   <div class="pull-right">
                   <a style=" margin-right: 15PX; margin-top: -3px" target="_blank" href="reportes/reportTipoPlato.php" class="btn btn-primary"><img src="assets/img/pdf.png" alt="" ></a>               
                   </div>
                  <p class="card-category"> Tipo de Platos Utilizados</p>
    ...
    <script src="assets/js/jquery.min.js"></script>
        ...
        var dataTable = $('#lookup').DataTable( {
         ...
         "language":  {
          ...
          "serverSide": true,
          "ajax":{
            url :"conn/TipoPlato/data-Plato.php", // json datasource
