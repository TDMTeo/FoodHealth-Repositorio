...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="../Chef/assets/css/bootstrap.css">
...
<body class="">
 ...
 <!--  Plugin for the Sliders, full documentation here: http://refreshless.com/nouislider/ -->
  ...
  <script src="../Chef/assets/js/vendor/jquery-1.12.4.min.js"></script>
        ...
        var dataTable = $('#lookup').DataTable( {
         ...
         "language":  {
          ...
          "serverSide": true,
          "ajax":{
            url :"../Chef/conn/Ingredients/data-IngreC.php", // json datasource
