...
class Usuario extends Conexion
  {
    ...
    public function login($user, $clave)
    {
      ...
      */
      ...
      $consulta = 'SELECT idUsuario, Nombres, Usuario, Correo, Clave, Perfil FROM usuarios WHERE Usuario = "'.$user.'" AND Clave=MD5("'.$clave.'")';
      /*
        ...
        */
        ...
        if($_SESSION['Perfil'=] = 1){
          echo('<script>window.location="../Logistica/Administrador.php"</script>');
           ...
           echo('<script>window.location="../Domiciliario/Inicio_Domiciliario.php"</script>');
