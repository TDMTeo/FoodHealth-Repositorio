              ...
              if(isset($_GET["status"]))
              {
                if($_GET["status"] === "1")
                {
                  ...
                  <div class="alert alert-success">
                    ...
                    <strong>Domiciliario editado Correctamente!</strong> 
                  </div>
                  <?php
                          ...
                          <tbody>
                            ...
                            while ($fila = mysqli_fetch_array($tabla)) { ?>
                              <tr>
                                ...
                                <td>
                                 <a rel="tooltip" title class="btn btn-danger btn-link btn-sm elmnbtn"  data-original-title="Eliminar" aria-describedby="tooltip578613">
  ...
  <!-------------------------------------------------- Modal para Agregar ------------------------------------------------------>
        ...
        <div class="modal fade" id="Eliminar" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="staticBackdropLabel" aria-hidden="true">
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              <div class="modal-header">
                <h5 class="modal-title" id="staticBackdropLabel">Eliminar Domiciliario</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true">&times;</span>
                </button>
              </div>
              ...
              <div class="modal-body">
                ...
                Estas seguro que quieres eliminar este domiciliario?
                <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-dismiss="modal">Cerrar</button>
                ...
                <form action="Domiciliario/Modificar.php" method="POST">
                  <div class="card-body">
                      ...
                      <div class="row">
                        <div class="col-md-6">
                          <div class="form-group">
                            <label class="bmd-label-floating">n_Documento</label>
