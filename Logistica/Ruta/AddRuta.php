  ...
  if(!isset($_SESSION['Perfil'])) 
  {
   ...
   // echo 'adsasdaddddddddddddddddddddddddddddddddddddddddasdwadwasdwasdwasdwasdwasdwasdwasdwasdwasdwasdwasdwasdwasdwasdwasdwasdwasdwasd'.$id.'<br>';

    // echo 'adsasdaddddddddddddddddddddddddddddddddddddddddasdwadwasdwasdwasdwasdwasdwasdwasdwasdwasdwasdwasdwasdwasdwasdwasdwasdwasdwasd'.$Estado;
 if (empty($id)) {
...
/*elseif ($Estado == '2' or $Estado == '3' or $Estado == '5 ') {
       echo '<body onload="document.formulario.submit()">
        <form action="index.php" method="post" name="formulario">
