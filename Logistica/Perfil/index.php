...
?>
    ...
    <?php include("../php/Conexion.php");
     ...
     $consulta = mysqli_query($conectar,'Select * From Usuarios,jefe_logistica,rol where usuarios.idUsuario = jefe_logistica.idUsuario and usuarios.Perfil = rol.idRol and usuarios.idUsuario ='. $idUsuario);

     $informacion = mysqli_fetch_array($consulta);

     $nombre = $informacion["nombres"];
     $apellidos = $informacion["apellidos"];
     $documento = $informacion["n_Documento"];
     $direccion = $informacion["direccion"];
     $telefono = $informacion["telefono"];
     $codigoPostal = $informacion["codigopostal"];
     $descripcion = $informacion["aboutme"];
     $nombreCompleto = $nombre. ' '. $apellidos;
     $foto = $informacion["foto"];
     $nombreRol = $informacion["nombre"];
                            ...
                            <div class="card">
                                ...
                                <div class="card-content">
                                    <h4 class="card-title">Perfil -
                                        <small class="category">Modifica tu perfil</small>
                                    </h4>
                                        <div class="row">
                                            <div class="col-md-6">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group label-floating">
                                                    ...
                                                    <input type="text" class="form-control" name="n_Documento" value="<?php echo $documento ?>" required>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group label-floating">
                                                    ...
                                                    <select name="TDocumento" class="form-control" title="tipoDocumento" required>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group label-floating">
                                                    ...
                                                    <input type="text" class="form-control"  name="codigopostal"  value="<?php echo $codigoPostal ?>" required>
                                                    <span class="help-block">Solo caracteres numericos</span>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group label-floating">
                                                    ...
                                                    <select  name="Municipio"  class="form-control" title="tipoMunicipio" required>
                                                        <option disabled="" selected="" value></option>
                                                        <?php
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-group label-floating">
                                                        <label class="control-label"> Breve descripcion suya.</label>
            ...
            if($_POST["mensaje"] === "1") {
              echo '<script>
                      $(document).ready(function() {
                       demo.showNotification("bottom","right","success",100,"perm_identity","Perfil modificado exitosamente");
                    });
                  </script>';
