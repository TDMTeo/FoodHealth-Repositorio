...
?>
    ...
    <?php include("../php/Conexion.php");
     ...
     $validacion = "select pedido.idPedido, concat(nombre,' ',apellido) as 'Nombre', FechaEntrega, pedido.DireccionPredeterminada, cliente.Direccion, estado, n_Documento 
         from cliente, pedido, estado 
         where Cliente.idCliente = Pedido.idCliente and Pedido.idEstado = Estado.idEstado and CodigoQR is null";

      $validacionB = mysqli_query($conectar, $validacion);

      while ($ValidarPedido = mysqli_fetch_array($validacionB)) {

          $idPedido = $ValidarPedido['idPedido'];
    ...
    <div class="main-panel">
        ...
        <div class="content">
            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <br>	
                    <h4 class="card-title">Generar QR</h4>
                    <?php 
                        if (empty($idPedido)) {
                            echo '
                            <blockquote class="blockquote">
                              <p class="mb-0">No se encuentran Pedidos sin Codigo QR</p>
                     ...
                     ?>
                              ...
                              <tbody>
                                <?php
                                $query = "select pedido.idPedido, concat(nombre,' ',apellido) as 'Nombre', FechaEntrega, pedido.DireccionPredeterminada, cliente.Direccion, estado, n_Documento 
									from cliente, pedido, estado 
									where Cliente.idCliente = Pedido.idCliente and Pedido.idEstado = Estado.idEstado and CodigoQR is null";
                                ...
                                while ($fila = mysqli_fetch_array($tabla)) {?>
                                  <tr>
	                                ...
	                                <td class="td-actions">
	                                  <a class="btn btn-primary btn-simple generar" rel="tooltip" title="Generar"  >
	   ...
	   <!-------------------------------------------------- Modal para Generar QR ------------------------------------------------------>
	    <div class="modal fade" id="Generar" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	        <div class="modal-dialog modal-small ">
	            <div class="modal-content">
	                <div class="modal-header text-center">
	                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true"><i class="material-icons">clear</i></button>
	                    <h5 class="modal-title" id="myModalLabel">Informacion del QR</h5>
	                </div>
		                <div class="modal-body text-center">
    	                    <form method="POST" action="../CodigoQR/generar.php"  class="form-horizontal">
                            ...
                            <div class="card-content">
                                ...
                                <input type="text" class="form-control" name="Pedido_id" id="Pedido_id" style="display:none">
                                <input type="text" name="n_Documento" id="n_Documento" style="display: none">
                            </div>
	                <div class="modal-footer text-center">
	                    <button type="button" class="btn btn-simple" data-dismiss="modal">Cerrar</button>
                        <input type="hidden" name="update_id" id="update_id" style="display: none">
	                    <button type="submit" class="btn btn-success btn-simple" name="Modificar" value="Modificar">Generar</button>
	                </div>
                 </form>
	            </div>
	          </div> 
            ...
            if($_POST["mensaje"] === "1") {
              echo '<script>
                      $(document).ready(function() {
                       demo.showNotification("bottom","right","success",100,"developer_mode","Codigo Creado exitosamente");
                    });
                  </script>';
