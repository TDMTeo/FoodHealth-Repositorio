...
?>
    ...
    <?php include("../php/Conexion.php");
     ...
     $validacion = "select pedido.idPedido, concat(nombre,' ',apellido) as 'Nombre', FechaEntrega, pedido.DireccionPredeterminada, cliente.Direccion, estado, n_Documento 
         ...
         where Cliente.idCliente = Pedido.idCliente and Pedido.idEstado = Estado.idEstado and estado.idEstado != 3";
        ...
        <div class="content">
            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <br>	
                    <h4 class="card-title">Cambiar Estados</h4>
                    <?php 
                        if (empty($idPedido)) {
                            echo '
                            <blockquote class="blockquote">
                              <p class="mb-0">No se encuentran Pedidos en un Estado apropiado para ser modificados</p>
                              ...
                              <tbody>
                                ...
                                while ($fila = mysqli_fetch_array($tabla)) {?>
                                  <tr>
	                                ...
	                                <td class="td-actions">
	                                  <a class="btn btn-primary btn-simple editbtn" rel="tooltip" title="Editar"  >
                        ...
                        <div class="modal-body text-center">
                            ...
                            <div class="card-content">
                                <div class="form-group label-floating">
                                 ...
                                 <input type="hidden" class="form-control" name="Estado_id" id="Estado_id">
            ...
            if($_POST["mensaje"] === "1") {
              echo '<script>
                      $(document).ready(function() {
                       demo.showNotification("bottom","right","success",100,"developer_mode","Estado editado Exitosamente");
                    });
                  </script>';
