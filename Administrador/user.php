...
$sql = mysqli_query($conn,"SELECT * FROM administrador WHERE idUsuario = '$id'");
...
<div class="subnavbar">
  <div class="subnavbar-inner">
    <div class="container">
      <ul class="mainnav">
        <li><a href="../Administrador/"><i class="icon-dashboard"></i><span>Inicio</span> </a> </li>
...
<div id="wrapper">
  ...
  <h1>Editar su perfil</h1><br>
  
  <form name="form1" id="form1" action="account/updateuser.php" method="POST">
    <div class="col-3">
      <label>
        Company
        <input type="text" required value="Food Health" readonly tabindex="2">
      </label>
    </div>
  <div class="col-3">
     <input  type="hidden" name="id" id="id" value="<?php echo $row['idAdministrador']; ?>" placeholder="Tidak perlu di isi" class="form-control span8 tip" readonly="readonly">
    <label>
      Tipo Documento
  ...
  <div class="col-3">
      <label>
        Email
        <input type="email" required value="<?php echo $rowa['Correo']; ?>" readonly tabindex="2">
      </label>
    </div>
  ...
  <div class="col-3">
    <label>
      Sobre Mi
      <input type="text" required maxlength="" placeholder="Ingrese una descripción" id="aboutme" 
      name="aboutme" tabindex="7" value="<?php echo $row['aboutme']; ?>">
    </label>
  </div>
  ...
  <div class="col-submit">
    <a href="../Administrador/" class="btn btn-danger"><i class="icon-remove"></i> Cancelar</a>
  </div>
