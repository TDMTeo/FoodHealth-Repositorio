...
if(isset($_POST['update'])){
				...
				$update = mysqli_query($conn, "UPDATE  administrador SET idTipoDocumento='$tipodocumento', n_Documento='$documento', nombres='$nombres', apellidos='$apellidos', telefono='$telefono', idMunicipio='$municipio', direccion='$direccion', codigopostal='$codigopostal', aboutme='$aboutme'  WHERE  idAdministrador='$id'") or die(mysqli_error());
