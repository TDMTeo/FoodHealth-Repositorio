...
if(isset($_POST['update'])){
				...
				$update = mysqli_query($conn, "UPDATE nutricionista SET idTipoDocumento='$tipodocumento', n_Documento='$documento', nombres='$nombres', apellidos='$apellidos', telefono='$telefono', idMunicipio='$municipio', direccion='$direccion', codigopostal='$codigopostal', estado='$estado'  WHERE idNutricionista='$id'") or die(mysqli_error());
				if($update){
					echo "<script>
                              Swal.fire({
                                icon: 'success',
