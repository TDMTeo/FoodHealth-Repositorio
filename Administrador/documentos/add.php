  ...
  <!-- /subnavbar-inner --> 
    ...
    <?php
            if(isset($_POST['input'])){
                ...
                $insert = mysqli_query($conn, "INSERT INTO tipodocumento(idTipoDocumento, nombre, estado)
...
<div id="wrapper">
  ...
  <h1>Agregar Documento</h1><br>
  
  <center><form name="form1" id="form1" action="add.php" method="POST">
  <div class="col-2">
    <label>
      Nombre del documento
      <input type="text" required minlength="3" placeholder="Ingrese el nombre del documento" id="nombre" name="nombre" tabindex="2">
    </label>
  </div>
