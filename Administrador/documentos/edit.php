...
<div class="subnavbar">
  <div class="subnavbar-inner">
    <div class="container">
      <ul class="mainnav">
        ...
        <li class="active"><a href="#"><i class="icon-picture"></i><span>Tipos Documentos</span> </a></li>
  ...
  <!-- /subnavbar-inner --> 
	 ...
	 <?php
           $id = $_GET['i'];
            ...
            $sql = mysqli_query($conn, "SELECT * FROM tipodocumento WHERE idTipoDocumento='$id'");
  ...
  <h1>Editar Documento</h1><br>
  
  <form name="form1" id="form1" action="update.php" method="POST">
  <div class="col-2">
     <input  type="hidden" name="id" id="id" value="<?php echo $row['idTipoDocumento']; ?>" placeholder="Tidak perlu di isi" class="form-control span8 tip" readonly="readonly">
    <label>
      Tipo Documento
      <input name="nombre" id="nombre" value="<?php echo $row['nombre']?>" placeholder="Ingrese nombre del documento" required minlength="2" type="text">
    </label>
  </div>
  ...
  <div class="col-submit">
    <a href="../documentos/" class="btn btn-danger"><i class="icon-remove"></i> Cancelar</a>
  </div>
