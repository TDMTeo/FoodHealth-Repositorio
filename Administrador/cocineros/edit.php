...
<?php
           $id = $_GET['i'];
            ...
            $sql = mysqli_query($conn, "SELECT * FROM cocineros WHERE idCocinero='$id'");
            if(mysqli_num_rows($sql) == 0){
                header('location: ../cocineros/');
            }else{
  ...
  <div class="col-3">
     <input  type="hidden" name="id" id="id" value="<?php echo $row['idCocinero']; ?>" placeholder="Tidak perlu di isi" class="form-control span8 tip" readonly="readonly">
    <label>
      Tipo Documento
