...
if(isset($_POST['update'])){
				...
				$update = mysqli_query($conn, "UPDATE  cocineros SET idTipoDocumento='$tipodocumento', n_Documento='$documento', nombres='$nombres', apellidos='$apellidos', telefono='$telefono', idMunicipio='$municipio', direccion='$direccion', codigopostal='$codigopostal', estado='$estado'  WHERE  idCocinero='$id'") or die(mysqli_error());
				if($update){
					echo "<script>
                              Swal.fire({
                                icon: 'success',
