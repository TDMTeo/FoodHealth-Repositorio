...
$sql = "SELECT  idCocinero, idTipoDocumento, n_Documento, nombres, apellidos, telefono, idMunicipio, direccion, idUsuario, codigopostal, aboutme, estado";
$sql.=" FROM cocineros";
