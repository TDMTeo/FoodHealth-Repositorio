...
<div class="subnavbar">
  <div class="subnavbar-inner">
    <div class="container">
      <ul class="mainnav">
        ...
        <li class="active"><a href="../perfiles/"><i class="icon-unlock"></i><span>Perfiles</span> </a></li>
  ...
  <!-- /subnavbar-inner --> 
	...
	<?php
           $id = $_GET['i'];
            ...
            $sql = mysqli_query($conn, "SELECT * FROM rol  WHERE idRol='$id'");
  ...
  <form name="form1" id="form1" action="update.php" method="POST">
    <div class="col-2">
     <input  type="hidden" name="id" id="id" value="<?php echo $row['idRol']; ?>" placeholder="Tidak perlu di isi" class="form-control span8 tip" readonly="readonly">
    <label>
      Nombre
      <input type="text" required minlength="5" placeholder="Ingrese el nombre del perfil" id="Nombre" name="Nombre"tabindex="1" value="<?php echo $row['Nombre']; ?>">
    </label>
  </div>
  ...
  <div class="col-submit">
    <a href="../perfiles/" class="btn btn-danger"><i class="icon-remove"></i> Cancelar</a>
  </div>
