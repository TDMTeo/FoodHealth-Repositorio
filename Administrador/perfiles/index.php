    ...
    <div class="container">
      <ul class="mainnav">
        ...
        <li class="dropdown"><a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown"> <i class="icon-long-arrow-down"></i><span>Empleados</span> <b class="caret"></b></a>
          <ul class="dropdown-menu">
            <li><a href="../nutrutuonist/">Nutricionistas</a></li>
	       ...
	       <div class="row">
            <div class="col-md-12">
              <div class="card">
               ...
               <div class="pull-right">
                    <a style=" margin-right: 5px; margin-left: 20px;" target="_blank" href="../reportes/reportPerfiles.php" class="btn btn-primary"><i class="icon-save"></i></a>             
                   </div>                    
                </div>
                <div class="card-body">
