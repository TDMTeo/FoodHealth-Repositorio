...
<div class="subnavbar">
  ...
  <!-- /subnavbar-inner --> 
	...
	<?php
           $id = $_GET['i'];
            ...
            $sql = mysqli_query($conn, "SELECT * FROM paquetes WHERE IdPaquete='$id'");
            if(mysqli_num_rows($sql) == 0){
                header('location: ../paquetes/');
            }else{
  ...
  <h1>Editar paquete</h1><br>
  
  <form name="form1" id="form1" action="update.php" method="POST">
    <div class="col-3">
     <input  type="hidden" name="id" id="id" value="<?php echo $row['IdPaquete']; ?>" placeholder="Tidak perlu di isi" class="form-control span8 tip" readonly="readonly">
    <label>
      Nombre
      <input type="text" required minlength="5" placeholder="Ingrese el nombre del paquete" id="Nombre" name="Nombre"tabindex="1" value="<?php echo $row['Nombre']; ?>">
    </label>
  </div>
  ...
  <div class="col-3">
    <label>
      ...
      <input type="text" required minlength="5" placeholder="Ingrese el tiempo" id="Tiempo" name="Tiempo" tabindex="2"
       value="<?php echo $row['Tiempo']; ?>">
    </label>
  </div>
    <div class="col-3">
    <label>
      Precio
      <input type="text" required minlength="5" placeholder="Ingrese el precio" id="Precio" name="Precio" tabindex="3"
    ...
    <label>
      Descripción
      <input type="text" required minlength="5" placeholder="Ingrese la descripción" id="Descripcion" name="Descripcion" tabindex="4" value="<?php echo $row['Descripcion']; ?>">
    </label>
  </div>
