...
<?php
            if(isset($_POST['input'])){
                ...
                $insert = mysqli_query($conn, "INSERT INTO tipocita(idTipoCita, Nombre, Estado)
...
<div id="wrapper">
  ...
  <h1>Agregar Tipo de Cita</h1><br>
  
 <center> <form name="form1" id="form1" action="add.php" method="POST">
  <div class="col-2">
    <label>
      Nombre
      <input type="text" required minlength="5" placeholder="Ingrese nombre del tipo cita" id="Nombre" name="Nombre" tabindex="2">
    </label>
  </div>
