...
<div class="subnavbar">
      ...
      <ul class="mainnav">
        ...
        <li class="dropdown active"><a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown"> <i class="icon-long-arrow-down"></i><span>Empleados</span> <b class="caret"></b></a>
          <ul class="dropdown-menu">
            ...
            <li class="active"><a href="../logisticsmanager/">Jefe de logística</a></li>
  ...
  <?php
           $id = $_GET['i'];
            ...
            $sql = mysqli_query($conn, "SELECT * FROM jefe_logistica WHERE idjefe_logistica='$id'");
            if(mysqli_num_rows($sql) == 0){
                header('location: ../logisticsmanager/');
            }else{
  ...
  <h1>Editar Jefe de Logística</h1><br>
  
  <form name="form1" id="form1" action="update.php" method="POST">
  <div class="col-3">
     <input  type="hidden" name="id" id="id" value="<?php echo $row['idjefe_logistica']; ?>" placeholder="Tidak perlu di isi" class="form-control span8 tip" readonly="readonly">
    <label>
      Tipo Documento
  ...
  <div class="col-submit">
    <a href="../logisticsmanager/" class="btn btn-danger"><i class="icon-remove"></i> Cancelar</a>
  </div>
