...
$sql = "SELECT idjefe_logistica, idTipoDocumento, n_Documento, nombres, apellidos, telefono, idMunicipio, direccion, idUsuario, codigopostal, aboutme, estado";
$sql.=" FROM jefe_logistica";
