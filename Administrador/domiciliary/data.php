...
$sql = "SELECT iddomiciliario, idTipoDocumento, n_Documento, nombres, apellidos, telefono, idMunicipio, direccion, idUsuario, codigopostal, aboutme, estado";
$sql.=" FROM domiciliario";
