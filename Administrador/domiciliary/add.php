                    ...
                    VALUES(NULL,'$usuario', '$correo', MD5('$clave'), 2)") or die(mysqli_error());
                        ...
                        if($insert){
                          ...
                          $consulta = mysqli_query($conn, "SELECT idUsuario FROM usuarios WHERE Usuario = '$usuario'");
                            ...
                            $insertcliente = mysqli_query($conn, "INSERT INTO  domiciliario(iddomiciliario, idTipoDocumento, n_Documento, nombres, apellidos, telefono, idMunicipio, direccion, idUsuario, codigopostal, aboutme, estado)
