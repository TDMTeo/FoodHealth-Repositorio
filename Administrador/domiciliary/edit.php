      ...
      <ul class="mainnav">
        ...
        <li class="dropdown active"><a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown"> <i class="icon-long-arrow-down"></i><span>Empleados</span> <b class="caret"></b></a>
          <ul class="dropdown-menu">
            ...
            <li class="active"><a href="#">Domiciliarios</a></li>
          </ul>
        </li>
...
<?php
           $id = $_GET['i'];
            ...
            $sql = mysqli_query($conn, "SELECT * FROM domiciliario WHERE iddomiciliario='$id'");
            if(mysqli_num_rows($sql) == 0){
                header('location: ../domiciliary/');
            }else{
  ...
  <h1>Editar Domiciliario</h1><br>
  
  <form name="form1" id="form1" action="update.php" method="POST">
  <div class="col-3">
     <input  type="hidden" name="id" id="id" value="<?php echo $row['iddomiciliario']; ?>" placeholder="Tidak perlu di isi" class="form-control span8 tip" readonly="readonly">
    <label>
      Tipo Documento
  ...
  <div class="col-submit">
    <a href="../domiciliary/" class="btn btn-danger"><i class="icon-remove"></i> Cancelar</a>
  </div>
