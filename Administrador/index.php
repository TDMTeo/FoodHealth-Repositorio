  ...
  <div class="subnavbar-inner">
    <div class="container">
      <ul class="mainnav">
        ...
        <li><a href="icons.php"><i class="icon-list-alt"></i><span>Iconos</span> </a></li>
      </ul>
    </div>
    <!-- /container --> 
  </div>
	     ...
	     <div class="row">
	      	...
	      	<div class="info-box">
               <div class="row-fluid stats-box">
                  <div class="span4">
                  	<div class="stats-box-title">Clientes Activos</div>
                  ...
                  <div class="span4">
                    <div class="stats-box-title">Menus preparados</div>
                  ...
                  <div class="span4">
                    <div class="stats-box-title">Pedidos entregados</div>
